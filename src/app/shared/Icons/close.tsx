...
const CloseIcon: React.FC<CloseIconProps> = ({ height = 24, width = 24, zIndex = 0 }) => {
  return (
    <svg fill="#000000" height={height} width={width} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ zIndex }}>
